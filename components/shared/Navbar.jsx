...
const Navbar = () => {
    return (
        <nav className='h-16 py-2 w-full px-2 md:px-8 lg:px-16 bg-white flex gap-4 justify-between items-center'>

            {/* logo - hidden at mobile screen */}
            <Image src={Logo} alt='linkedin logo' className='h-7 w-fit hidden md:block' />

            {/* logo - hidden at desktop */}
            <button className='block md:hidden text-blue-400 text-4xl'>
                <FaLinkedin />
            </button>
            ...
            <div className='relative w-full lg:w-fit'>
                ...
                <button className='h-10 w-10 pr-1 rounded-r-lg lg:rounded-r-2xl text-white bg-blue-400 absolute right-0 top-0 bottom-0 hidden md:flex justify-center items-center'>
                    <LuSearch />
                </button>
